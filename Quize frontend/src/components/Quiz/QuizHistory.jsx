                ...
                <tr key={attempt.id}>
                  ...
                  <td className="px-6 py-4">
                    <Link
                      ...
                      className="text-[#091057] hover:text-[#1E2A5E]"
                    >
                      Retake Quiz
                    </Link>
                  </td>
          ...
          <table className="min-w-full">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Date</th>
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Results Found</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-gray-200">
          ...
          <table className="min-w-full">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Times Taken</th>
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Actions</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-gray-200">
              {createdQuizzes.map((quiz) => (
                <tr key={quiz.id}>
                  ...
                  <td className="px-6 py-4">{quiz.attemptCount}</td>
                  <td className="px-6 py-4">
                    <Link
                      to={`/edit-quiz/${quiz.id}`}
                      className="text-[#091057] hover:text-[#1E2A5E] mr-4"
                    >
                      Edit
                    </Link>
                    <Link
