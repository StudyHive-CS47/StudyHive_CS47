...
function Header() {
    return (
        <header className="las_header">
            <div className="las_header-content">
                <div className="las_header-left">
                    <img src={logo} alt="StudyHive" className="las_header-logo" />
                    <h1 className="las_header-title">StudyHive</h1>
                </div>
                <nav className="las_header-nav">
                    <a href="#">Home</a>
                ...
                <div className="las_header-right">
                    <button className="las_search-button">
                    ...
                    <button className="las_profile-button">
