...
function App() {
  ...
  return (
    <div className="relative min-h-screen bg-[#ebf8e1] flex flex-col">
      <Pattern className="fixed" />
      ...
      <div className="relative z-10 flex-grow">
        ...
        <section className="relative pt-20 pb-16">
          <div className="container mx-auto px-4">
            <div className="flex flex-col items-center text-center">
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-[#3f87a6] mb-6">
                Your go-to space for<br />
                <span className="relative inline-block">
                  stress-free
                  <span className="absolute bottom-2 left-0 w-full h-3 bg-[#c73030] opacity-20 -z-10"></span>
        ...
        <section className="py-8">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-bold text-center mb-16">
              Everything you need to study <span className="text-[#3f87a6]">Smarter</span>
            </h2>
        ...
        <section className="py-20 bg-gradient-to-b from-[#ebf8e1] to-white">
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
              {testimonials.map((testimonial, index) => (
                <div key={index} 
                     className="bg-gray-50 p-8 rounded-2xl shadow-[0_20px_30px_-20px_rgba(5,5,5,0.24)] 
                                transform hover:-translate-y-2 transition-all duration-300">
                  <div className="flex items-center gap-4">
                    <div className="h-16 w-16 rounded-full overflow-hidden bg-blue-600">
                      <img 
        ...
        <section className="py-20 bg-white">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-12 text-[#3f87a6]">
              Meet Our Team
            </h2>
      ...
      <footer className="relative z-10 w-full px-12 py-4 flex justify-between items-center bg-white border-t border-gray-200">
        <div className="flex items-center gap-3">
          <img src={logo} alt="StudyHive" className="h-10 w-auto" />
          <h2 className="text-2xl font-semibold text-gray-900">StudyHive</h2>
        </div>
        
        <div className="flex gap-8">
          <a href="/about" className="text-gray-900 hover:text-gray-600 font-medium transition-colors">About</a>
          <a href="/features" className="text-gray-900 hover:text-gray-600 font-medium transition-colors">Features</a>
          <a href="/feedback" className="text-gray-900 hover:text-gray-600 font-medium transition-colors">Feedback</a>
          <a href="/donate" className="text-gray-900 hover:text-gray-600 font-medium transition-colors">Donate</a>
          <a href="/team" className="text-gray-900 hover:text-gray-600 font-medium transition-colors">Team</a>
        </div>
        
        <div className="flex gap-6">
          <a 
            href="https://www.facebook.com/profile.php?id=61570160061839" 
            className="text-gray-900 hover:text-gray-600 text-xl transition-colors"
          >
